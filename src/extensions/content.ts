...
const Tools = () => {
  ...
  toolWrapper.innerHTML = `
    ...
    <div class="${styles.feature}">
      ...
      <div id="colors" class="${styles.colorList}">
  ...
  // toolWrapper.innerHTML = `
    // <div class="${styles.colorButton}" style="background-color:rgb(0, 0, 0)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(255,255,255)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(255,59,48)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(255,149,0)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(255,204,0)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(76,217,100)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(90,200,250)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(0,122,255)"></div>
    // <div class="${styles.colorButton}" style="background-color:rgb(88,86,214)"></div>
  // `;
